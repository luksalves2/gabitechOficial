...
import 'cadastro_cidadao_model.dart';
export 'cadastro_cidadao_model.dart';

class CadastroCidadaoWidget extends StatefulWidget {
  const CadastroCidadaoWidget({
    super.key,
  ...
  @override
  State<CadastroCidadaoWidget> createState() => _CadastroCidadaoWidgetState();
}

class _CadastroCidadaoWidgetState extends State<CadastroCidadaoWidget> {
  late CadastroCidadaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroCidadaoModel());
    ...
    _model.txtRefrenciaTextController ??= TextEditingController();
    _model.txtRefrenciaFocusNode ??= FocusNode();

    _model.txtPerfilTextController ??= TextEditingController();
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                validator: _model
                                    ...
                                    .asValidator(context),
                                inputFormatters: [_model.txtDataNascimentoMask],
                              ),
                            ),
                          ),
                        ],
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        focusNode: _model.txtRefrenciaFocusNode,
                                        onChanged: (_) => EasyDebounce.debounce(
                                          '_model.txtRefrenciaTextController',
                                          Duration(milliseconds: 0),
                                          () => safeSetState(() {}),
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'v7kuedlr' /* ex: Jornalista, Repórter... */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                await CidadaosTable().insert({
                                  ...
                                  'perfil': _model.txtPerfilTextController.text,
                                  ...
                                  'estado': _model.txtEstadoTextController.text,
                                  'complemento':
                                      _model.txtComplementoTextController.text,
                                  'ponto_referencia':
                                      _model.txtRefrenciaTextController.text,
                                  'numero_residencia':
