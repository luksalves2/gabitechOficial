...
import 'modal_edit_cad_cidadao_model.dart';
export 'modal_edit_cad_cidadao_model.dart';

class ModalEditCadCidadaoWidget extends StatefulWidget {
  const ModalEditCadCidadaoWidget({super.key});

  @override
  State<ModalEditCadCidadaoWidget> createState() =>
      _ModalEditCadCidadaoWidgetState();
}

class _ModalEditCadCidadaoWidgetState extends State<ModalEditCadCidadaoWidget>
    with TickerProviderStateMixin {
  late ModalEditCadCidadaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalEditCadCidadaoModel());
    ...
    _model.dataaniverTextController ??= TextEditingController();
    _model.dataaniverFocusNode ??= FocusNode();
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'bvy3fs93' /* Cadastro e alteração dos dados... */,
                      ),
                            ...
                            Expanded(
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    16.0, 0.0, 16.0, 0.0),
                                child: TextFormField(
                                  controller: _model.dataaniverTextController,
                                  focusNode: _model.dataaniverFocusNode,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      '95wuxn2s' /* Data de nascimento */,
                                    ),
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primary,
                                  validator: _model
                                      .dataaniverTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: FlutterFlowDropDown<String>(
                                  controller:
                                      _model.dropDowncadUserValueController ??=
                                          FormFieldController<String>(null),
                                  options: [
                                    FFLocalizations.of(context).getText(
                                      '2o3hq6ih' /* Option 1 */,
                                  ...
                                  onChanged: (val) => safeSetState(
                                      () => _model.dropDowncadUserValue = val),
                                  width: 300.0,
                                  height: 50.0,
                                  textStyle: FlutterFlowTheme.of(context)
                                      .bodyMedium
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await CidadaosTable().insert({
                                    ...
                                    'phone': _model.cpfTextController.text,
                                    'logradouro':
                                    ...
                                    'update_at': supaSerialize<DateTime>(
                                        getCurrentTimestamp),
                                    'connected_phone': FFAppState().phoneAdmin,
                                    'data_nascimento_s':
                                        _model.dataaniverTextController.text,
