        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          if (FFAppState().homeDashboard)
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  12.0, 0.0, 0.0, 0.0),
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'yg07zi4c' /* Visão Geral */,
                                ),
              ...
              if (FFAppState().homeMensagens)
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      FFAppState().msgAtendimentoStatus = true;
                      safeSetState(() {});
              ...
              if (FFAppState().homeSolicitacoes)
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 5.0),
                  child: InkWell(
                    splashColor: Colors.transparent,
                    ...
                    onTap: () async {
                      ...
                      context.pushNamed(
                        MainSolicitacoesKanbanWidget.routeName,
                        extra: <String, dynamic>{
                          kTransitionInfoKey: TransitionInfo(
                            hasTransition: true,
                            transitionType: PageTransitionType.fade,
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      ...
                      context.pushNamed(
                        MainAtividadesWidget.routeName,
                        extra: <String, dynamic>{
                          kTransitionInfoKey: TransitionInfo(
                            hasTransition: true,
                            transitionType: PageTransitionType.fade,
              ...
              if (FFAppState().homeTransmissoes)
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 5.0),
                  child: InkWell(
                    splashColor: Colors.transparent,
                    ...
                    onTap: () async {
                      ...
                      context.pushNamed(
                        MainTransmissoesWidget.routeName,
                        extra: <String, dynamic>{
                          kTransitionInfoKey: TransitionInfo(
                            hasTransition: true,
                            transitionType: PageTransitionType.fade,
              ...
              if (FFAppState().homeNotificacoes)
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 5.0),
                  child: InkWell(
                    splashColor: Colors.transparent,
              ...
              if (FFAppState().homeMapas)
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      context.pushNamed(
                        MainGeolocalizacaoWidget.routeName,
                        extra: <String, dynamic>{
                          kTransitionInfoKey: TransitionInfo(
                            hasTransition: true,
                            transitionType: PageTransitionType.fade,
              ...
              if (FFAppState().homePerfil)
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      if (FFAppState().homeAdmin) {
                        context.pushNamed(MainProfilePageAdminWidget.routeName);
                      } else {
                        context.pushNamed(
