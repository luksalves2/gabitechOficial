                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller: _model
                                        ...
                                        TextEditingController(
                                      text:
                                          containerCidadaosRow?.dataNascimento,
                                    ),
                                    focusNode:
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            controller: _model
                                                ...
                                                TextEditingController(
                                              text:
                                                  containerCidadaosRow?.estado,
                                            ),
                                            focusNode:
                                                _model.txtEstadoFocusNode,
                                            onChanged: (_) =>
                                                EasyDebounce.debounce(
                                              '_model.txtEstadoTextController',
                                              Duration(milliseconds: 0),
                                  ...
                                  onPressed: () async {
                                    ...
                                    await CidadaosTable().update(
                                      data: {
                                        ...
                                        'longitude': ObterLatitudeLongitudeCall
                                            .longitude(
                                          (_model.obterLatLng?.jsonBody ?? ''),
                                        )?.toString(),
                                        'numero_residencia':
