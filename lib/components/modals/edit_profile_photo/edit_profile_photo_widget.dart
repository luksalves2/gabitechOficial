                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'yaxe7q8v' /* Carregue uma nova foto abaixo ... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                                          ...
                                          if (selectedMedia != null &&
                                              selectedMedia.every((m) =>
                                                  validateFileFormat(
                                                      ...
                                                      context))) {
                                            safeSetState(() => _model
                                                    .isDataUploading_uploadDataImagettUsersr =
                                                true);
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_uploadDataImagettUsersr =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                ...
                                                downloadUrls.length ==
                                                    selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFile_uploadDataImagettUsersr =
                                                    selectedUploadedFiles.first;
                                                _model.uploadedFileUrl_uploadDataImagettUsersr =
                                                    downloadUrls.first;
                                              });
                                            } else {
                                              safeSetState(() {});
