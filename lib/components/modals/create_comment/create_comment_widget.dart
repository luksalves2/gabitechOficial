                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'd6yfe8tj' /* incluir notas referente a ativ... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                          ...
                          children: [
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await NotasAtividadesTable().insert({
                                    'descricao':
                                        _model.shortBioTextController.text,
                                    'data_criacao': supaSerialize<DateTime>(
                                        getCurrentTimestamp),
                                    'user_id': widget!.userId,
                                    'atividade_id': widget!.atividade,
                                    'nome_user': widget!.nomeUser,
                                    'gabinete_id': FFAppState().gabineteId,
                                    'descricao_responsavel_atendimento':
                                        widget!.nomeResponsavel,
                                  });
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Nota incluida com Sucesso!',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .primaryText,
                                        ),
