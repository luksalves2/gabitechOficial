...
import 'editar_cidadao_widget.dart' show EditarCidadaoWidget;
...
class EditarCidadaoModel extends FlutterFlowModel<EditarCidadaoWidget> {
  ...
  // Stores action output result for [Backend Call - API (Obter Latitude Longitude)] action in Button widget.
