...
import '/components/modals/modal_cad_atividades/modal_cad_atividades_widget.dart';
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      ...
                                      content: Text(
                                          'Atualizações será lançado em Breve'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                    ...
                    FutureBuilder<List<NotasAtividadesRow>>(
                      future: NotasAtividadesTable().queryRows(
                        queryFn: (q) => q.order('data_criacao'),
                      ),
                      builder: (context, snapshot) {
                        ...
                        List<NotasAtividadesRow>
                            listViewNotasAtividadesRowList = snapshot.data!;
                        ...
                        return ListView.builder(
                          ...
                          itemCount: listViewNotasAtividadesRowList.length,
                          itemBuilder: (context, listViewIndex) {
                            final listViewNotasAtividadesRow =
                                listViewNotasAtividadesRowList[listViewIndex];
                            return Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  20.0, 12.0, 20.0, 16.0),
                              child: Container(
                        ...
                        builder: (context) {
                          return Padding(
                            ...
                            child: Container(
                              ...
                              child: ModalCadAtividadesWidget(),
                            ),
                          );
                        },
