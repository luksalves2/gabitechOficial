...
import 'cadastrar_acessor_model.dart';
export 'cadastrar_acessor_model.dart';

class CadastrarAcessorWidget extends StatefulWidget {
  const CadastrarAcessorWidget({
    super.key,
  ...
  @override
  State<CadastrarAcessorWidget> createState() => _CadastrarAcessorWidgetState();
}

class _CadastrarAcessorWidgetState extends State<CadastrarAcessorWidget> {
  late CadastrarAcessorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastrarAcessorModel());
    ...
    _model.atendimentoValue = false;
    _model.solicitacoeSwitchValue = false;
    _model.cidadaosValue = false;
    _model.atividadeSwitchValue = false;
    _model.transmissaoSwitchValue = false;
    _model.dashboardValue = false;
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      '5gypcnvh' /* Informe a senha de acesso */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Switch.adaptive(
                                    value: _model.atendimentoValue!,
                                    onChanged: (newValue) async {
                                      safeSetState(() =>
                                          _model.atendimentoValue = newValue!);
                                    },
                                    activeColor:
                                        FlutterFlowTheme.of(context).primary,
                                    activeTrackColor:
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Switch.adaptive(
                                      value: _model.solicitacoeSwitchValue!,
                                      onChanged: (newValue) async {
                                        safeSetState(() =>
                                            _model.solicitacoeSwitchValue =
                                                newValue!);
                                      },
                                      activeColor:
                                          FlutterFlowTheme.of(context).primary,
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Switch.adaptive(
                                      value: _model.cidadaosValue!,
                                      onChanged: (newValue) async {
                                        safeSetState(() =>
                                            _model.cidadaosValue = newValue!);
                                      },
                                      activeColor:
                                          FlutterFlowTheme.of(context).primary,
                                      activeTrackColor:
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Switch.adaptive(
                                      value: _model.atividadeSwitchValue!,
                                      onChanged: (newValue) async {
                                        safeSetState(() => _model
                                            .atividadeSwitchValue = newValue!);
                                      },
                                      activeColor:
                                          FlutterFlowTheme.of(context).primary,
                                      activeTrackColor:
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Switch.adaptive(
                                      value: _model.transmissaoSwitchValue!,
                                      onChanged: (newValue) async {
                                        safeSetState(() =>
                                            _model.transmissaoSwitchValue =
                                                newValue!);
                                      },
                                      activeColor:
                                          FlutterFlowTheme.of(context).primary,
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Switch.adaptive(
                                      value: _model.dashboardValue!,
                                      onChanged: (newValue) async {
                                        safeSetState(() =>
                                            _model.dashboardValue = newValue!);
                                      },
                                      activeColor:
                                          FlutterFlowTheme.of(context).primary,
                                      activeTrackColor:
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  _model.novoAcessor = await SupabaseGroup
                                      .cadastrarAcessorCall
                                      .call(
                                    email: _model.txtEmailTextController.text,
                                    senha: _model.txtSenhaTextController.text,
                                  );

                                  if ((_model.novoAcessor?.succeeded ?? true)) {
                                    await UsuariosTable().insert({
                                      'created_at': supaSerialize<DateTime>(
                                          getCurrentTimestamp),
                                      'uuid': SupabaseGroup.cadastrarAcessorCall
                                          .uuid(
                                        (_model.novoAcessor?.jsonBody ?? ''),
                                      ),
                                      ...
                                      'ultima_atualizacao':
                                          supaSerialize<DateTime>(
                                              getCurrentTimestamp),
                                      'atendimento': _model.atendimentoValue,
                                      'solicitacoes':
                                          _model.solicitacoeSwitchValue,
                                      'cidadaos': _model.cidadaosValue,
                                      'atividades': _model.atividadeSwitchValue,
                                      'dashboard': _model.dashboardValue,
                                      'acessores': false,
                                      'transmissao':
                                          _model.transmissaoSwitchValue,
                                      'cargo':
