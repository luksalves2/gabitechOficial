...
class SolicitacoesCidadoesTcontatosTable
    extends SupabaseTable<SolicitacoesCidadoesTcontatosRow> {
  @override
  String get tableName => 'solicitacoes_cidadoes_tcontatos';

  @override
  SolicitacoesCidadoesTcontatosRow createRow(Map<String, dynamic> data) =>
      SolicitacoesCidadoesTcontatosRow(data);
}

class SolicitacoesCidadoesTcontatosRow extends SupabaseDataRow {
  SolicitacoesCidadoesTcontatosRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => SolicitacoesCidadoesTcontatosTable();
