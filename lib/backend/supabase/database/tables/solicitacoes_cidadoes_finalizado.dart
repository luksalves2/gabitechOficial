...
class SolicitacoesCidadoesFinalizadoTable
    extends SupabaseTable<SolicitacoesCidadoesFinalizadoRow> {
  @override
  String get tableName => 'solicitacoes_cidadoes_finalizado';

  @override
  SolicitacoesCidadoesFinalizadoRow createRow(Map<String, dynamic> data) =>
      SolicitacoesCidadoesFinalizadoRow(data);
}

class SolicitacoesCidadoesFinalizadoRow extends SupabaseDataRow {
  SolicitacoesCidadoesFinalizadoRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => SolicitacoesCidadoesFinalizadoTable();
