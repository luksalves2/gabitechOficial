...
class SolicitacoesCidadoesAndamentoTable
    extends SupabaseTable<SolicitacoesCidadoesAndamentoRow> {
  @override
  String get tableName => 'solicitacoes_cidadoes_andamento';

  @override
  SolicitacoesCidadoesAndamentoRow createRow(Map<String, dynamic> data) =>
      SolicitacoesCidadoesAndamentoRow(data);
}

class SolicitacoesCidadoesAndamentoRow extends SupabaseDataRow {
  SolicitacoesCidadoesAndamentoRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => SolicitacoesCidadoesAndamentoTable();
