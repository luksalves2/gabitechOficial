...
class SolicitacoesCidadoesTable extends SupabaseTable<SolicitacoesCidadoesRow> {
  @override
  String get tableName => 'solicitacoes_cidadoes';

  @override
  SolicitacoesCidadoesRow createRow(Map<String, dynamic> data) =>
      SolicitacoesCidadoesRow(data);
}

class SolicitacoesCidadoesRow extends SupabaseDataRow {
  SolicitacoesCidadoesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => SolicitacoesCidadoesTable();
