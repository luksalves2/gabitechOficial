...
class SolicitacoesAtrasadasTable
    extends SupabaseTable<SolicitacoesAtrasadasRow> {
  @override
  String get tableName => 'solicitacoes_atrasadas';

  @override
  SolicitacoesAtrasadasRow createRow(Map<String, dynamic> data) =>
      SolicitacoesAtrasadasRow(data);
}

class SolicitacoesAtrasadasRow extends SupabaseDataRow {
  SolicitacoesAtrasadasRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => SolicitacoesAtrasadasTable();
