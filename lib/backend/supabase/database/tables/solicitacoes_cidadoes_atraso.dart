...
class SolicitacoesCidadoesAtrasoTable
    extends SupabaseTable<SolicitacoesCidadoesAtrasoRow> {
  @override
  String get tableName => 'solicitacoes_cidadoes_atraso';

  @override
  SolicitacoesCidadoesAtrasoRow createRow(Map<String, dynamic> data) =>
      SolicitacoesCidadoesAtrasoRow(data);
}

class SolicitacoesCidadoesAtrasoRow extends SupabaseDataRow {
  SolicitacoesCidadoesAtrasoRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => SolicitacoesCidadoesAtrasoTable();
