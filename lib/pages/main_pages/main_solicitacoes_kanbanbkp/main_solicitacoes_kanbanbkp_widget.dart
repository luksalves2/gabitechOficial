...
import '/components/modals/editcard_seguinte/editcard_seguinte_widget.dart';
...
import 'main_solicitacoes_kanbanbkp_model.dart';
export 'main_solicitacoes_kanbanbkp_model.dart';

class MainSolicitacoesKanbanbkpWidget extends StatefulWidget {
  const MainSolicitacoesKanbanbkpWidget({super.key});

  static String routeName = 'Main_solicitacoesKanbanbkp';
  static String routePath = 'Main_solicitacoesKanbanbkp';

  @override
  State<MainSolicitacoesKanbanbkpWidget> createState() =>
      _MainSolicitacoesKanbanbkpWidgetState();
}

class _MainSolicitacoesKanbanbkpWidgetState
    extends State<MainSolicitacoesKanbanbkpWidget>
    with TickerProviderStateMixin {
  late MainSolicitacoesKanbanbkpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainSolicitacoesKanbanbkpModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<SolicitacoesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SolicitacoesRow> mainSolicitacoesKanbanbkpSolicitacoesRowList =
            snapshot.data!;
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'gq4k4thf' /* Centralize aqui todas as deman... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                                  ...
                                                  children: [
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'yrlkg0mf' /* Total de Solicitações */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                  ...
                                                  children: [
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'qubr1tro' /* Tempo Médio de resolução */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                  ...
                                                  children: [
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        '1lvgj25s' /* Total de solicitações no mês a... */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                  ...
                                                  children: [
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'foi78kmn' /* Total de solicitações em atend... */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                              ...
                                              child: Padding(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Builder(
                                                    builder: (context) {
                                                      final todos =
                                                          mainSolicitacoesKanbanbkpSolicitacoesRowList
                                                              .toList();
                                                                              ...
                                                                              children: [
                                                                                Text(
                                                                                  'Prazo: ${valueOrDefault<String>(
                                                                                    dateTimeFormat(
                                                                                      "dd/MM/yyyy",
                                                                                      emAnaliseItem.dtFimAtendimento,
                                                                                      locale: FFLocalizations.of(context).languageCode,
                                                                                    ),
                                                                                    'Não informado',
                                                                                  )}',
                                                                                              ...
                                                                                              builder: (dialogContext) {
                                                                                                return Dialog(
                                                                                                  ...
                                                                                                  child: GestureDetector(
                                                                                                    ...
                                                                                                    child: EditcardSeguinteWidget(
                                                                                                      solid: emAnaliseItem.solidId,
                                                                                                    ),
                                                                                                  ),
                                                                                                );
                                                                                              },
                                                                                      ...
                                                                                      child: InkWell(
                                                                                        ...
                                                                                        onTap: () async {
                                                                                          var confirmDialogResponse = await showDialog<bool>(
                                                                                                ...
                                                                                                builder: (alertDialogContext) {
                                                                                                  return AlertDialog(
                                                                                                    title: Text('Avançar para etapa Em andamento?'),
                                                                                                    content: Text('Essa ação não poderá ser desfeita'),
                                                                                                    actions: [
                                                                                                      TextButton(
                                                                                                        onPressed: () => Navigator.pop(alertDialogContext, false),
                                                              ...
                                                              return Draggable<
                                                                ...
                                                                feedback:
                                                                  ...
                                                                  child:
                                                                      Visibility(
                                                                    visible:
                                                                        emAndamentoItem.statusAtendimento ==
                                                                            2,
                                                                    child:
                                                                        Padding(
                                                                      padding: EdgeInsetsDirectional.fromSTEB(
                                                                                    ...
                                                                                    Padding(
                                                                                      ...
                                                                                      child: Text(
                                                                                        'Prazo: ${valueOrDefault<String>(
                                                                                          dateTimeFormat(
                                                                                            "dd/MM/yyyy",
                                                                                            emAndamentoItem.dtFimAtendimento,
                                                                                            locale: FFLocalizations.of(context).languageCode,
                                                                                          ),
                                                                                          'Não informado',
                                                                                        )}',
