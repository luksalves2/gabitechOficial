...
import 'main_solici_kanban_bkp_model.dart';
export 'main_solici_kanban_bkp_model.dart';

class MainSoliciKanbanBkpWidget extends StatefulWidget {
  const MainSoliciKanbanBkpWidget({super.key});

  static String routeName = 'Main_soliciKanbanBkp';
  static String routePath = 'Main_soliciKanbanBkp';

  @override
  State<MainSoliciKanbanBkpWidget> createState() =>
      _MainSoliciKanbanBkpWidgetState();
}

class _MainSoliciKanbanBkpWidgetState extends State<MainSoliciKanbanBkpWidget>
    with TickerProviderStateMixin {
  late MainSoliciKanbanBkpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainSoliciKanbanBkpModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<SolicitacoesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SolicitacoesRow> mainSoliciKanbanBkpSolicitacoesRowList =
            snapshot.data!;
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'ufely3ul' /* Centralize aqui todas as deman... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                                  ...
                                                  children: [
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        '37hkzqv1' /* Total de Solicitações */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                  ...
                                                  children: [
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'igv0myzb' /* Tempo Médio de resolução */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                  ...
                                                  children: [
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'ymtkwscd' /* Total de solicitações no mês a... */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                  ...
                                                  children: [
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        '1fl6f7kk' /* Total de solicitações em atend... */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                              ...
                                              child: Padding(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Builder(
                                                    builder: (context) {
                                                      final todos =
                                                          mainSoliciKanbanBkpSolicitacoesRowList
                                                              .toList();
