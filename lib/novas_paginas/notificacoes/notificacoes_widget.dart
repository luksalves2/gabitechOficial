                ...
                Expanded(
                  child: FutureBuilder<List<GabineteRow>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final columnGabineteRow = columnGabineteRowList.isNotEmpty
                                          ...
                                          Expanded(
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'zijwej0s' /* Gerencie suas notificações */,
                                              ),
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                                                            ...
                                                                            return GestureDetector(
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: DetalhesSolicitacoesWidget(
                                                                                  idSolicitacao: columnNotificacoesRow.solicitacao!,
                                                                                ),
                                                                              ),
                                                                            );
                                                                          },
                                                                    ...
                                                                    children: [
                                                                      Expanded(
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            columnNotificacoesRow.descricao,
                                                                            '-',
                                                                          ),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
