...
class AtualizarSenhaWidget extends StatefulWidget {
  const AtualizarSenhaWidget({super.key});

  @override
  State<AtualizarSenhaWidget> createState() => _AtualizarSenhaWidgetState();
}
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        if (_model.txtNovaSenhaTextController.text ==
                          ...
                          if ((_model.atualizarSenha?.succeeded ?? true)) {
