  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: FutureBuilder<List<TarefasRow>>(
        future: TarefasTable().querySingleRow(
        ...
        builder: (context, snapshot) {
          ...
          List<TarefasRow> containerTarefasRowList = snapshot.data!;

          final containerTarefasRow = containerTarefasRowList.isNotEmpty
              ? containerTarefasRowList.first
              : null;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.txtTituloTextController ??=
                                ...
                                text: containerTarefasRow?.titulo,
                              ),
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: FFLocalizations.of(context).getText(
                                  'q0g6m5vp' /* Ex: Organizar documentos */,
                                ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.txtDescricaoTextController ??=
                                  TextEditingController(
                                text: containerTarefasRow?.descricao,
                              ),
