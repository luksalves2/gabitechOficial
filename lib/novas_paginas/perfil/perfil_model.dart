...
class PerfilModel extends FlutterFlowModel<PerfilWidget> {
  ...
  bool isDataUploading_uploadData75n = false;
  FFUploadedFile uploadedLocalFile_uploadData75n =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_uploadData75n = '';

  Completer<List<GabineteRow>>? requestCompleter1;
  ...
  Completer<List<GabineteRow>>? requestCompleter2;
