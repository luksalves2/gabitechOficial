...
import 'criar_nota_solicitacao_model.dart';
export 'criar_nota_solicitacao_model.dart';

class CriarNotaSolicitacaoWidget extends StatefulWidget {
  const CriarNotaSolicitacaoWidget({
    super.key,
  ...
  @override
  State<CriarNotaSolicitacaoWidget> createState() =>
      _CriarNotaSolicitacaoWidgetState();
}

class _CriarNotaSolicitacaoWidgetState
    extends State<CriarNotaSolicitacaoWidget> {
  late CriarNotaSolicitacaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriarNotaSolicitacaoModel());
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              '4pmryjqm' /* Ex: Organizar documentos */,
                            ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await NotasTable().insert({
                          'created_at':
                              supaSerialize<DateTime>(getCurrentTimestamp),
                          'solicitacao': widget!.idSolicitacao,
